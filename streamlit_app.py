...
genai.configure(api_key="AIzaSyCd6WeZtdhALRdXWKrYy_dK2D8PqV3Zmjc") #config.
...
st.sidebar.header("Bot GPT")
st.sidebar.write("Made by Aryan")
st.sidebar.write("\n\nAssistant used is Gemini Pro Vision.")
st.header("Bot GPT")
